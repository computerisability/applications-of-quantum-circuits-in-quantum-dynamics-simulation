...
ansatz = AnsatzLadderHubbard(n_qubits, depth = 1)   
...
#n0n4 = observables_values[0::2]
n0n4 = observables_values[1::2]                                    #若为8个比特，则这里还有
...
np.savez('hubbard_dual_adam_.npz', n0n4 = n0n4,
...
with open('hubbard_dual_adam_.qpy', 'wb') as f:                              #量子电路算出来，需要保存为qpy文件
    qpy.dump(a, f)  
