...
from adaptive_pvqd_local import AdaptivePVQD
...
ansatz = AnsatzLadderHubbard(n_qubits, depth=0)                    #原始代码此处为3，而adaptive这里其实是0
...
np.savez('hubbard_local.npz', n0n4 = n0n4, n0n2 = n0n2,    #若为8个比特，则此处还有n0n4
...
with open('hubbard_local.qpy', 'wb') as f:                              #量子电路算出来，需要保存为qpy文件
    qpy.dump(a, f)  
