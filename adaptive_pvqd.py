...
class AdaptivePVQD:
    ...
    def adaptive_step(
        ...
        print('--------------------------')
        print(f'Start of an block step')
        ...
        #self.ansatz.circuit = new_circuit_ansatz  # Overwrite the current circuit重点检查这句
        #以上是block方法
...
# 提取目标门数量（如果不存在则返回0）
            ...
            print(f'the type of evolved_state is :{type(evolved_state)}')
            data_log["evolved state"].append(evolved_state)
            ...
            #z0z2=[arr[2] for arr in data_log["observables values"]]
            #print('below is z0')
